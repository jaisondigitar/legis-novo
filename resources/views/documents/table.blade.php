...
<div id="answer" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('document.reply')}}" enctype="multipart/form-data" name="reply-form" id="reply-form">
                @csrf
...
<script>
    ...
    const answer = (document) => {
        CKEDITOR.instances.comissionDescriprion.setData(document.description);
        $('#answer #document_id').attr('value', document.id);
        $('#answer').modal();
    };
