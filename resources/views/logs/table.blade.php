    ...
    @foreach($logs as $log)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    @shield('logs.show')  <button id="advice_{{$log->id}}" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal" onclick="getLog({{$log}})"><i class="glyphicon glyphicon-eye-open"></i></button>@endshield
