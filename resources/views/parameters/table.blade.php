    ...
    @foreach($parameters as $parameters)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    @shield('parameters.show')<a href="{!! route('parameters.show', [$parameters->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>@endshield
                    @shield('parameters.edit')<a href="{!! route('parameters.edit', [$parameters->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>@endshield
