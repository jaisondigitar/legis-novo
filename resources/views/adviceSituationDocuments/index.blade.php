    ...
    <div style="margin: 1rem 3.125rem 1rem 3.125rem" class="the-box rounded">
        <div class="row">
            <div class="col-md-12">
                <div class="btn-toolbar" role="toolbar">
                    <div class="btn-group">
                        @shield('adviceSituationDocuments.create')
                            <a href="{!! route('adviceSituationDocuments.create') !!}">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @if($adviceSituationDocuments->isEmpty())
                    <div class="well text-center">Sem dados. Insira um novo registro.</div>
                @else
                    @include('adviceSituationDocuments.table')
                @endif
            </div>
        </div>
    </div>
