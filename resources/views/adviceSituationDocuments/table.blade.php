        ...
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    ...
                    @shield('adviceSituationDocuments.delete'){!! Form::button('<i @popper(Deletar) class="glyphicon glyphicon-trash"></i>', ['type' => 'submit', 'class' => 'btn btn-danger btn-xs', 'onclick' => 'sweet(event)' ]) !!}@endshield
                </div>
                {!! Form::close() !!}
            </td>
        </tr>
