        ...
        <tr>
            ...
            <td>
                @if($lawsProject->project_number > 0)
                    <label class="label label-success">{{ $lawsProject->protocol }}</label>
                @else
            ...
            <td>
                @if($lawsProject->is_ready == 1)
                    <label class="label label-success">SANCIONADA</label></span>
                @else
                    <span align="center"><label class="label label-danger">Não</label></span>
                @endif
