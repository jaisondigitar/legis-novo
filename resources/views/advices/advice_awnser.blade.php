            ...
            <div class="col-sm-12">
                <div class="panel-group" id="accordion-1">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <a class="block-collapse collapsed" data-bs-toggle="collapse" href="#accordion-1-child-1" aria-expanded="false">
                                    @if($advice->project)
                        ...
                        <div class="collapse" id="accordion-1-child-1">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <a class="block-collapse collapsed" data-bs-toggle="collapse" href="#accordion-1-child-2" aria-expanded="false">
                                    Dados do pedido
                                    <span class="right-content">
                        ...
                        <div class="collapse" id="accordion-1-child-2">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <b>Data:</b> <br/>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <a class="block-collapse collapsed" data-bs-toggle="collapse" href="#accordion-1-child-3" aria-expanded="false">
                                    Pareceres
                                    <span class="right-content">
                                        <span class="right-icon">
                                            <i class="glyphicon glyphicon-plus icon-collapse"></i>
                        ...
                        <div class="collapse" id="accordion-1-child-3">
                            <div class="panel-body">
