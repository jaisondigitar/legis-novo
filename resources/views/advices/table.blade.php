    ...
    @foreach($advices as $advice)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    @shield('advices.show')<a href="{!! route('$ROUTES_AS_PREFIX$advices.show', [$advice->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>@endshield
