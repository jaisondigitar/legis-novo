<table class="table table-bordered table-striped table-hover display nowrap">
    ...
    @foreach($companies as $company)
        <tr>
            ...
            <td>
                <a href="{!! route('companies.show', [$company->id]) !!}"><i class="fa fa-cogs icon-rounded icon-xs icon-info"></i></a>
                <a href="{!! route('companies.edit', [$company->id]) !!}"><i class="fa fa-pencil icon-rounded icon-xs icon-warning"></i></a>
