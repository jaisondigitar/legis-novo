...
//
//
//Route::resource('$ROUTES_PREFIX$adviceAwnsers', '$NS_PREFIX$AdviceAwnserController');
//Route::get('/$ROUTES_PREFIX$adviceAwnsers/{id}/toggle','$NS_PREFIX$AdviceAwnserController@toggle');
