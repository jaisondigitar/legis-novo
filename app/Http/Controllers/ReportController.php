...
class ReportController extends AppBaseController
{
    ...
    public function pdfNoFiles()
    {
        ...
        $pdf->setFooterData($doc->getNumber(), [0, 64, 0], [0, 64, 128]);
...
//      return $content;
    ...
    {
        $documents = self::getLawsProject($request);
...
//        }
        ...
        $pdf->setFooterData($doc->getNumberLaw(), [0, 64, 0], [0, 64, 128]);
        $pdf->setFooterFont([PDF_FONT_NAME_DATA, '', PDF_FONT_SIZE_DATA]);
        $pdf->SetDefaultMonospacedFont(PDF_FONT_MONOSPACED);
        $pdf->SetMargins($margemEsquerda, $marginHeader, $margemDireita);
        $pdf->SetHeaderMargin($margemSuperior);
...
//        $doc       = LawsProject::find($doc_id);
     ...
     */
    public static function documentsVerify(Collection $documents, string $path_to_return)
    {
